...
import static com.servalabs.linkcheck.utilities.methods.JavaUtils.negate;
...
import com.servalabs.linkcheck.utilities.wrappers.ProgressDialog;
import com.servalabs.linkcheck.utilities.wrappers.ZipReader;
import com.servalabs.linkcheck.utilities.wrappers.ZipWriter;
...
public class BackupActivity extends Activity {
    ...
    private String getInitialFile() {
        return "Serva LinkCheck_" + new SimpleDateFormat("yyyyMMddHHmmss", Locale.US).format(new Date()) + ".ucbckp";
    }
